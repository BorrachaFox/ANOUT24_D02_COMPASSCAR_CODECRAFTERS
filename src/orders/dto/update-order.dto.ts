...
import { IsDate, IsIn, IsInt, IsNotEmpty, IsOptional, IsString, ValidateIf } from "class-validator";
...
export class UpdateOrderDTO {
  ...
  @ValidateDateRange({ message: 'The end date cannot be less than the start date.' })
  final_date: Date;
